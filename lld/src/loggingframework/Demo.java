...
public class Demo {
    public static void main(String[] args) {
        ...
        // REMOVED: mainLogger.setLevel(LogLevel.FATAL); // This was blocking everything!
        // OR SET TO: mainLogger.setLevel(LogLevel.DEBUG); // To see all messages

        mainLogger.fatal("Application starting up.");
        mainLogger.debug("This is a debug message, it should NOT appear."); // Below root level (INFO)
        mainLogger.warn("This is a warning message."); // Should appear now!
